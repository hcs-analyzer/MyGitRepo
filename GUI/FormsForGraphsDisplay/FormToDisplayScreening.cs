...
namespace HCSAnalyzer.Controls
{
     ...
     //   cScreening CompleteScreening;
        ...
        private void FormToDisplayPlate_MouseClick(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                contextMenuStrip.Items.Add(this.AssociatedPlate.GetExtendedContextMenu());
    ...
    public partial class FormToDisplayDescriptorPlate : cPanelForDisplayArray
    {
        ...
        public FormToDisplayDescriptorPlate(cPlate PlateToDisplay, cScreening CompleteScreening, int DescIdx)
        {
            ...
            this.MouseDown += new MouseEventHandler(this.FormToDisplayDescriptorPlate_MouseClick);
        ...
        private void FormToDisplayDescriptorPlate_MouseClick(object sender,MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ContextMenuStrip contextMenuStrip = new ContextMenuStrip();
                foreach (var item in cGlobalInfo.CurrentScreening.ListDescriptors[IdxDesc].GetExtendedContextMenu())
                {
