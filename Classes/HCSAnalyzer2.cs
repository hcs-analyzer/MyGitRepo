    ...
    public partial class HCSAnalyzer : Form
    {
        ...
        private void AverageOperationsToDescriptorItem(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (MainWindow.radioButtonSine.Checked)
                    OperationType = eUnaryOperationType.SIN;
                else if (MainWindow.radioButtonCosine.Checked)
                    OperationType = eUnaryOperationType.COS;
                    ...
                    foreach (cWell Tmpwell in CurrentPlate.ListActiveWells)
                    {
                        ...
                        switch (OperationType)
                        {
...
#if BUILD64
                                if (double.IsInfinity(Val) || double.IsNaN(Val)) Val = (long)double.Epsilon;
#else
                            ...
                            case eUnaryOperationType.EXP:
                                ...
                                break;                 
                            case eUnaryOperationType.SIN:
                                Val = Math.Sin(Tmpwell.GetAverageValue(DescType1));
                                break;                            
                            case eUnaryOperationType.COS:
                                Val = Math.Cos(Tmpwell.GetAverageValue(DescType1));
                                break;
                            default:
                                break;
                        }
        ...
        private void SubPopulationStatDescItem(object sender, EventArgs e)
        {
            ...
            if ((NewWindow.comboBoxStatistics.Text != "Average") && (NewWindow.comboBoxStatistics.Text != "Stdev") &&
                (NewWindow.comboBoxStatistics.Text != "Min") && (NewWindow.comboBoxStatistics.Text != "Max") &&
                    ...
                    if (CT.Count == 1)
                    {
                        ...
                        else
                        {
                            if (NewWindow.comboBoxStatistics.Text == "Average")
                                ...
                                Value = CT[0].CV();
                            else if (NewWindow.comboBoxStatistics.Text == "Max")
                                Value = CT[0].Max();
                            else if (NewWindow.comboBoxStatistics.Text == "Min")
                                Value = CT[0].Min();
                        }
                    }
