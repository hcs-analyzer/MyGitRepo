...
namespace HCSAnalyzer.Classes.General_Types
{
    public class cListWells : List<cWell>
    {
        ...
        void ToolStripMenuItem_GetTable(object sender, EventArgs e)
        {
            ...
            GLWV.ListProperties.FindByName("Include Classes?").SetNewValue((bool)false);
            GLWV.ListProperties.FindByName("Include Classes?").IsGUIforValue = true;
        ...
        void ToolStripMenuItem_Display2DScatter(object sender, EventArgs e)
        {
           cFeedBackMessage MessageReturned;
            ...
            // cListWell ListWellsToProcess = new cListWell();
               ...
               // cListWells ListWellsToProcess = this;

                cExtendedTable DataFromPlate = new cExtendedTable(this, true);
                ...
                V1D.Chart.IsSelectable = true;
                V1D.Chart.CurrentTitle.Tag = this.Count + " well(s)";
        ...
        public void SingleCellBasedAnalysis()
        {
            ...
            foreach (cWell TmpWell in this)
            {
                ...
                cListSingleBiologicalObjects ListPhenotypes = TmpWell.GetPhenotypesList();


                TmpTable.ListTags = new List<object>();
                foreach (var item in ListPhenotypes)
                {
                    TmpTable.ListTags.Add(item);
                }
        ...
        public ToolStripMenuItem GetContextMenu()
        {
            ...
            ToolStripMenuItem ToolStripMenuItem_Display2DScatter = new ToolStripMenuItem("2D Scatter Plot");
            ToolStripMenuItem_Display2DScatter.Click += new System.EventHandler(this.ToolStripMenuItem_Display2DScatter);
            ToolStripMenuItem_DisplayAS.DropDownItems.Add(ToolStripMenuItem_Display2DScatter);
