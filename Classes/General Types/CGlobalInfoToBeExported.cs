...
namespace HCSAnalyzer.Classes.General_Types
{
    ...
    public class cDataForcGlobalInfoToBeExported
    {
        ...
        public bool radioButtonImageAccessBuiltInKineticChecked;
        ...
        public string ImageFielddescriptor;
        public string Object_Min_X_Descriptor;
        public string Object_Min_Y_Descriptor;
        public string Object_Max_X_Descriptor;
        public string Object_Max_Y_Descriptor;
        public bool checkBoxSingleObjectInvertedYChecked;
    ...
    public class cGlobalInfoToBeExported
    {
        ...
        public string Save(string Path)
        {
            ...
            DataForcGlobalInfoToBeExported.radioButtonImageAccessBuiltInKineticChecked = cGlobalInfo.OptionsWindow.radioButtonImageAccessBuiltInKinetic.Checked;
            ...
            DataForcGlobalInfoToBeExported.ImageFielddescriptor = cGlobalInfo.OptionsWindow.comboBoxDescriptorForField.Text;
            DataForcGlobalInfoToBeExported.Object_Max_X_Descriptor = cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMaxX.Text;
            DataForcGlobalInfoToBeExported.Object_Min_X_Descriptor = cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMinX.Text;
            DataForcGlobalInfoToBeExported.Object_Max_Y_Descriptor = cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMaxY.Text;
            DataForcGlobalInfoToBeExported.Object_Min_Y_Descriptor = cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMinY.Text;

            DataForcGlobalInfoToBeExported.checkBoxSingleObjectInvertedYChecked = cGlobalInfo.OptionsWindow.checkBoxSingleObjectInvertedY.Checked;
        ...
        public void Load(string Path)
        {
            ...
            if (MyObj.radioButtonImageAccessBuiltInKineticChecked != null)
                cGlobalInfo.OptionsWindow.radioButtonImageAccessBuiltInKinetic.Checked = MyObj.radioButtonImageAccessBuiltInKineticChecked;

            if (MyObj.checkBoxSingleObjectInvertedYChecked != null)
                cGlobalInfo.OptionsWindow.checkBoxSingleObjectInvertedY.Checked = MyObj.checkBoxSingleObjectInvertedYChecked;
            ...
            if (MyObj.numericUpDownDefaultField != null)
                cGlobalInfo.OptionsWindow.numericUpDownDefaultField.Value = (decimal)MyObj.numericUpDownDefaultField;

            if ((MyObj.ImageFielddescriptor != null) && (cGlobalInfo.OptionsWindow.comboBoxDescriptorForField.Items.Contains(MyObj.ImageFielddescriptor)))
                cGlobalInfo.OptionsWindow.comboBoxDescriptorForField.Text = MyObj.ImageFielddescriptor;
            else
                cGlobalInfo.OptionsWindow.comboBoxDescriptorForField.Text = "";

            if ((MyObj.Object_Max_X_Descriptor != null) && (cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMaxX.Items.Contains(MyObj.Object_Max_X_Descriptor)))
                cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMaxX.Text = MyObj.Object_Max_X_Descriptor;
            else
                cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMaxX.Text = "";

            if ((MyObj.Object_Max_Y_Descriptor != null) && (cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMaxY.Items.Contains(MyObj.Object_Max_Y_Descriptor)))
                cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMaxY.Text = MyObj.Object_Max_Y_Descriptor;
            else
                cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMaxY.Text = "";

            if ((MyObj.Object_Min_X_Descriptor != null) && (cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMinX.Items.Contains(MyObj.Object_Min_X_Descriptor)))
                cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMinX.Text = MyObj.Object_Min_X_Descriptor;
            else
                cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMinX.Text = "";

            if ((MyObj.Object_Min_Y_Descriptor != null) && (cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMinY.Items.Contains(MyObj.Object_Min_Y_Descriptor)))
                cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMinY.Text = MyObj.Object_Min_Y_Descriptor;
            else
                cGlobalInfo.OptionsWindow.comboBoxDescForBoundingMinY.Text = "";

            cGlobalInfo.OptionsWindow.UpdateImageAccessor();
