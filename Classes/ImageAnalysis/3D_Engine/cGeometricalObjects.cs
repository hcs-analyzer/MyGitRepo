...
namespace HCSAnalyzer.Classes._3D
{
    ...
    public class c3DDRC_Curve : cGeometric3DObject
    {
        ...
        void Run(cPoint3D Center, Color Color)
        {
            ...
            cPoint3D CoordFirstPt = new cPoint3D(0,0,0);
            ...
            for (i = 0; i < NumberOfPt; i++)
            {
                ...
                if (i == 0)
                    CoordFirstPt = new cPoint3D(vX,vY,vZ);


                points.InsertPoint(i, vX - CoordFirstPt.X, vY - CoordFirstPt.Y, vZ - CoordFirstPt.Z); 
               // points.InsertPoint(i, vX - CoordFirstPt.X, vY, vZ);
    ...
    public class c3DTexturedPlan : cGeometric3DObject
    {
        ...
        public void Run()
        {
            ...
            // else
            {
                ...
                cImageDisplayProperties IDP = cGlobalInfo.TmpImageDisplayProperties;
    ...
    /// Textured Plan
    /// </summary>
    public class c3DLegend : cGeometric3DObject
    {
        cPoint3D Center = new cPoint3D(0, 0, 0);
        vtkLegendBoxActor legend;
        List<string> ListNames = new List<string>();
        vtkCubeSource legendBox;

        public c3DLegend(cPoint3D Center, List<string> ListNames)
        {
            //this.Tag = AssociatedImage;
            this.SetPosition(new cPoint3D(Center.X, Center.Y, Center.Z));
            this.SetName("Legend");
        ...
        public void Run()
        {
            ...
            // Create a plane
         //   legend = vtkLegendBoxActor.New();
         //   legend.SetNumberOfEntries(this.ListNames.Count);

         //   legendBox = vtkCubeSource.New();

         //   //vtkNamedColors colors = vtkNamedColors.New();
         //  //vtkColorSeries V = vtkColorSeries.New();
         ...
         // legend.GetActualPositionCoordinate().SetCoordinateSystemToView();
         ...
         // World.AddViewProp(this.ListActors[i]);
