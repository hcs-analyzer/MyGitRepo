...
namespace HCSAnalyzer.Forms.FormsForImages
{
    public class cImagePanel : Panel
    {
        ...
        public cImagePanel()
        {
            ...
            ToolStripMenuItem ToolStripMenuItem_Edges_Grad = new ToolStripMenuItem("Gradient");
            ToolStripMenuItem_Edges.DropDownItems.Add(ToolStripMenuItem_Edges_Grad);
            ToolStripMenuItem_Edges_Grad.Click += new System.EventHandler(this.ToolStripMenuItem_Edges_Grad);
          
            ToolStripMenuItem ToolStripMenuItem_Edges_ZeroCrossing = new ToolStripMenuItem("Zero crossings");
            ToolStripMenuItem_Edges.DropDownItems.Add(ToolStripMenuItem_Edges_ZeroCrossing);
            ToolStripMenuItem_Edges_ZeroCrossing.Click += new System.EventHandler(this.ToolStripMenuItem_Edges_ZeroCrossing);
            ...
            ToolStripMenuItem ToolStripMenuItem_GeometricalTranslate = new ToolStripMenuItem("Translate");
            ToolStripMenuItem_GeometricalManip.DropDownItems.Add(ToolStripMenuItem_GeometricalTranslate);
            ToolStripMenuItem_GeometricalTranslate.Click += new System.EventHandler(this.ToolStripMenuItem_GeometricalTranslate);
            ...
            ToolStripMenuItem ToolStripMenuItem_SplitByChannels = new ToolStripMenuItem("Split by Channels");
            ...
            ToolStripMenuItem ToolStripMenuItem_SplitZToChannels = new ToolStripMenuItem("Split Z to Channels");
            ToolStripMenuItem_Transforms.DropDownItems.Add(ToolStripMenuItem_SplitZToChannels);
            ToolStripMenuItem_SplitZToChannels.Click += new System.EventHandler(this.ToolStripMenuItem_SplitZToChannels);
            ...
            ToolStripMenuItem _ToolStripMenuItemRetrieveObject = new ToolStripMenuItem("Retrieve Object");
            ImageContextMenu.Items.Add(_ToolStripMenuItemRetrieveObject);
            _ToolStripMenuItemRetrieveObject.Click += new System.EventHandler(this._ToolStripMenuItemRetrieveObject);         
        ...
        private void ToolStripMenuItem_GeometricalTranslate(object sender, EventArgs e)
        {
            cDisplaySingleImage NewView = new cDisplaySingleImage();

            cImageGeometricTranslate GT = new cImageGeometricTranslate();
            GT.SetInputData(this.AssociatedImage);

            GT.ListProperties.FindByName("X").SetNewValue((double)0);
            GT.ListProperties.FindByName("X").IsGUIforValue = true;
            GT.ListProperties.FindByName("Y").SetNewValue((double)0);
            GT.ListProperties.FindByName("Y").IsGUIforValue = true;

            cFeedBackMessage FeedBackMessage = GT.Run();
            ...
            NewView.SetInputData(GT.GetOutPut());
            NewView.Run();
        ...
        public Point ConvertPanelCoordToImageCoord(Point PanelCoord)
        {
        ...
        private void ToolStripMenuItem_GeometricalCrop(object sender, EventArgs e)
        {
            ...
            Point ConvertedBottom = this.Selection.GetConvertedPosition_Bottom();
            Point ConvertedTop = this.Selection.GetConvertedPosition_Top();
            ...
            NewView.Run();
            NewView.MyImageViewer.ImagePanel.LUTManager.UpdateFromDisplayProperties(TmpProp);
        }
        ...
        private void ToolStripMenuItem_Edges_ZeroCrossing(object sender, EventArgs e)
        {
            cDisplaySingleImage NewView = new cDisplaySingleImage();

            cZeroCrossings ZC = new cZeroCrossings();
            ZC.SetInputData(this.AssociatedImage);
            ZC.Run();
            NewView.SetInputData(ZC.GetOutPut());

            NewView.Run();
        }

        private void ToolStripMenuItem_Edges_Grad(object sender, EventArgs e)
        {
            cDisplaySingleImage NewView = new cDisplaySingleImage();

            cImageGradient G = new cImageGradient(eGradType.MAX);
            //cImage2ndDerivative G = new cImage2ndDerivative(e2ndDerivativeType.CROSSED);
            G.SetInputData(this.AssociatedImage);
            //G.GreyThreshold = 10;
            //G.GreyThresholdLinkin = 60;
            G.Run();
            NewView.SetInputData(G.GetOutPut());
        ...
        private void ToolStripMenuItem_SplitZToChannels(object sender, EventArgs e)
        {
            cImageSplitZToChannels IS2C = new cImageSplitZToChannels();
            IS2C.SetInputData(this.AssociatedImage);

            IS2C.ListProperties.FindByName("Number of Channels").SetNewValue((int)3);
            IS2C.ListProperties.FindByName("Number of Channels").PropertyType.Min = 1;
            IS2C.ListProperties.FindByName("Number of Channels").PropertyType.Max = this.AssociatedImage.Depth;
            IS2C.ListProperties.FindByName("Number of Channels").IsGUIforValue = true;

            cFeedBackMessage FeedBackMessage = IS2C.Run();

            cDisplaySingleImage NewView = new cDisplaySingleImage();
            NewView.SetInputData(IS2C.GetOutPut());
            NewView.Run();
        ...
        private void _ToolStripMenuItem_UIModeSelection(object sender, EventArgs e)
        {
            ...
            this.Selection = new cSelection(this);
            RefreshBMP();
        }
        ...
        void DrawLayers()
        {
            ...
            foreach (string k in list)
            {
                ...
                {
                    cSquare CurrentSquare = ((cSquare)TmpObj);

                    Brush NewBrush = new SolidBrush(CurrentSquare.ObjectColor);

                    float Width = (float)CurrentSquare.Size.X * ZoomFactor;
                    float Height = (float)CurrentSquare.Size.Y * ZoomFactor;
                    float PosX = (float)CurrentSquare.Pos.X * ZoomFactor + TmpShiftX;
                    float PosY = (float)CurrentSquare.Pos.Y * ZoomFactor + TmpShiftY;
        ...
        private void _ToolStripMenuItemInfo(object sender, EventArgs e)
        {
            ...
            if (this.ToolStripMenuItem_UIModeSelection.Checked)
            {
                cDisplayListExtendedTable DLET = new cDisplayListExtendedTable();
                cListExtendedTable LET = new cListExtendedTable(ET);
        ...
        private void _ToolStripMenuItemRetrieveObject(object sender, EventArgs e)
        {
            // first get the associated well and site
            //this.AssociatedImage.Tag
        ...
        public void panelForImage_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (ToolStripMenuItem_UIModeSelection.Checked)
            {
                ...
                if (e.Button == MouseButtons.Left)
                {
                    ...
                    this.Selection.mRect = new Rectangle(BottomX, BottomY, TopX - BottomX, TopY - BottomY);
                    ...
                    int RealWidth = (int)((100 * (this.Selection.mRect.Width)) / (float)Zoom);
                    int RealHeight = (int)((100 * (this.Selection.mRect.Height)) / (float)Zoom);
                    ...
                    ThisGraph.DrawRectangle(MyPen, this.Selection.mRect);
                    ThisGraph.FillRectangle(NewBrush, this.Selection.mRect);
                    NewBrush.Dispose();
