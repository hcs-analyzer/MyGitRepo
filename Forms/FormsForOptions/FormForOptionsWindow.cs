...
namespace HCSAnalyzer
{
    ...
    public partial class FormForOptionsWindow : Form
    {
        ...
        public void UpdateImageAccessor()
        {
            ...
            else if (this.radioButtonImageAccessBuiltInKinetic.Checked)
                cGlobalInfo.ImageAccessor.ImagingPlatformType = Classes.General_Types.eImagingPlatformType.KINETIC;
            else if (this.radioButtonImageAccessNone.Checked)
        ...
        private void radioButtonImageAccessManual_CheckedChanged(object sender, EventArgs e)
        {
            ...
            groupBoxNone.Enabled = false;
            groupBoxManual.Enabled = true;
        }


        private void radioButtonImageAccessNone_CheckedChanged(object sender, EventArgs e)
        {
            groupBoxDefined.Enabled = false;
            groupBoxNone.Enabled = true;
        ...
        {
            if (radioButtonImageAccessHarmony35.Checked || radioButtonImageAccessINCell.Checked 
                || radioButtonImageAccessCV7000.Checked || radioButtonImageAccessBuiltIn.Checked 
                || radioButtonImageAccessCellomics.Checked || radioButtonImageAccessBuiltInKinetic.Checked) 
                numericUpDownImageAccessNumberOfChannels.Enabled = false;
            else
                numericUpDownImageAccessNumberOfChannels.Enabled = true;
        }
        ...
        private void radioButtonImageAccessBuiltInKinetic_CheckedChanged(object sender, EventArgs e)
        {
            UpdateLabelPath();
            UpdateNumChanneslGUI();
        }
        ...
        private void buttonSelectReportingFolder_Click(object sender, EventArgs e)
        {
            var dlg1 = new Ionic.Utils.FolderBrowserDialogEx();
            dlg1.Description = "Select the folder for your reports.";
            dlg1.ShowNewFolderButton = true;
            dlg1.ShowEditBox = true;
            //dlg1.NewStyle = false;
            //  dlg1.SelectedPath = txtExtractDirectory.Text;
            ...
            dlg1.SelectedPath = this.textBoxReportingFolder.Text;
            ...
            //if (OpenFolderDialog.ShowDialog() != DialogResult.OK) return;
            this.textBoxReportingFolder.Text = dlg1.SelectedPath;
        }

        private void setCurrentScreeningDirectoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (cGlobalInfo.CurrentScreening == null) return;
            textBoxImageAccesImagePath.Text = cGlobalInfo.CurrentScreening.GetDirectory();
        }

        private void checkBoxDefaultField_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBoxDefaultField.Checked) numericUpDownDefaultField.Enabled = true;
            else numericUpDownDefaultField.Enabled = false;
        }
